#ifndef INNLEVERING1_ALPHABET_H
#define INNLEVERING1_ALPHABET_H

#include <Arduino.h>

/**
 * This header defines the font used in the program. It is supplied by cosmicvoid and
